    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.iconContainer}>
          <Ionicons name="key" size={50} color="#1a73e8" />
        </View>
        
        <Text style={styles.title}>
          {step === 'create' ? 'Create your UPI PIN' : 'Confirm your UPI PIN'}
        </Text>
        <Text style={styles.subtitle}>
          {step === 'create' 
            ? 'Enter a 4-digit PIN for payments' 
        ...
        {step === 'confirm' && (
          ...
          >
            <Text style={styles.backText}>← Back to create PIN</Text>
          </TouchableOpacity>
        )}
      </View>
    </SafeAreaView>
